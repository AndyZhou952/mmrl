...
| **GitHub** | https://github.com/yifan123/flow_grpo (same repo as Flow-GRPO; `scripts/multi_node/sd3_grpo_guard.sh`) · [project page](https://jingw193.github.io/GRPO-Guard/) |
...
$$\delta_t = \begin{cases} 1/\Delta t & \text{for flow matching (FlowGRPO, MixGRPO)} \\ \beta_t/\Delta t & \text{for DDPM (DanceGRPO)} \end{cases}$$
